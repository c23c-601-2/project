...
#menu_wrap {width:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
					    ...
					    for ( var i=0; i<places.length; i++ ) {
					        ...
					        (function(marker, title) {
					            kakao.maps.event.addListener(marker, 'click', function(placePosition) {
					            	 ...
					            	     return function() {
					            	 출처: https://xianeml.tistory.com/75 [미현 개발 TIL:티스토리]
